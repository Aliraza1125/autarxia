...
const ControlDetailsSection = () => {
  return (
    <div className="max-w-[1200px] mx-auto px-4 py-16 text-justify">
      {/* Title Section */}
      <div className="mb-12">
        <h1 className="font-caviar text-[34px] leading-tight tracking-widest">
      ...
      {/* Subtitle */}
      <div className="mb-6">
        <h2 className="font-arial text-[18px] font-bold text-black">
      ...
      <div className="grid grid-cols-2 gap-20 mb-12">
        ...
        <div className="space-y-2 tracking-wider pr-4">
      ...
      <div className="space-y-8">
        ...
        <p className="font-arial text-[15px] leading-[25px] text-black tracking-wider">
          ...
          Hybridkraftwerk so einige zu tun: <br /> so müssen zum Beispiel der Oder die
          Batteriespeicher geregelt werden, damit überschüssige Energie
          gespeichert wer- den kann und zum richtigen Zeitpunkt und mit der
          richtigen Leistung abgegeben werden kann. Sind mehrere Batterie-
          speicher vorhanden, müssen diese miteinander zu einem virtuellen,
